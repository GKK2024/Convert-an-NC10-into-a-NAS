...
> [!NOTE]
>
> 1.目录"~/software_home"是本篇笔记统一存放程序的目录。
>
> 2.命令中凡是没有提示“sudo su”或使用“sudo”的命令，均是在普通用户下安装的程序。
>
> 3.GitHub 加速：https://github.moeyy.xyz/	|	https://gh.llkk.cc/
...
# WebUI访问的账户和密码,默认：transmission ;密码通常是加密内容。
...
[Debian 手工安装 Transmission 和设置中文教程 以及一键脚本](https://262235.xyz/index.php/archives/510/) | [Ubuntu/Debian安装transmission并美化WEB界面](https://blog.xwyue.com/1048.html) | [Transmission 配置文件参数解释](https://hackfang.me/transmission-webui-config) | [Transmission-web-control Wiki (github.com)](https://github.com/ronggang/transmission-web-control/wiki/Home-CN)  
...
> 编辑 "suwayomi.service" ，添加代码块的内容。

```
sudo nano /etc/systemd/system/suwayomi.service
```
...
# "test"填写真是用户名
User=test
ExecStart=/usr/bin/java -Dsuwayomi.tachidesk.config.server.rootDir="/home/test/software_home/suwayomi-Server_home" -jar /home/your_username/software_home/suwayomi-Server_home/Suwayomi-Server.jar
WorkingDirectory=/home/your_username/software_home/suwayomi-Server_home
Restart=on-failure
RestartSec=30
...
```
sudo systemctl daemon-reload
sudo systemctl start suwayomi.service
sudo systemctl enable suwayomi.service
sudo systemctl status suwayomi.service
```
...
帮助文档：[kkFileView · 部署](https://kkfileview.keking.cn/zh-cn/docs/production.html) | 
...
帮助文档：[flare原版 · Github](https://github.com/soulteary/flare) | [flaring修改版 · Github](https://github.com/LightAPIs/flaring?tab=readme-ov-file) 
